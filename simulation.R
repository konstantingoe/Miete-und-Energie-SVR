...
wohnk.df <- cbind(data[,c("owner", "belastet", "hgowner", "hhrf")], wohnk.df)


wohnk.gesamt <- sapply(5:ncol(wohnk.df), function(c) weighted.mean(wohnk.df[,c], wohnk.df$hhrf,na.rm = T))
wohnk.gesamt_mieter <- sapply(5:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,hgowner == 2)[,c], filter(wohnk.df,hgowner == 2)$hhrf,na.rm = T))
wohnk.gesamt_eigbel <- sapply(5:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,owner == 1 & belastet == 1)[,c], filter(wohnk.df,owner == 1 & belastet == 1)$hhrf,na.rm = T))
wohnk.gesamt_eigunbel <- sapply(5:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,owner == 1 & belastet == 0)[,c], filter(wohnk.df,owner == 1 & belastet == 0)$hhrf,na.rm = T))



#gesamte Wohnkosten für HH ohne Rücklagen
wohnk.df <- as.data.frame(wohnk.mat)
wohnk.df <- cbind(data[,c("owner", "belastet", "hgowner", "hhrf", "notrücklagen")], wohnk.df)


wohnk.ges_nor <- sapply(6:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df, notrücklagen == 0)[,c], filter(wohnk.df, notrücklagen == 0)$hhrf,na.rm = T))
wohnk.ges_nor_mieter <- sapply(6:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,hgowner == 2 & notrücklagen == 0)[,c], filter(wohnk.df,hgowner == 2 & notrücklagen == 0)$hhrf,na.rm = T))
wohnk.ges_nor_eigbel <- sapply(6:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,owner == 1 & belastet == 1 & notrücklagen == 0)[,c], filter(wohnk.df,owner == 1 & belastet == 1 & notrücklagen == 0)$hhrf,na.rm = T))
wohnk.ges_nor_eigunbel <- sapply(6:ncol(wohnk.df), function(c) weighted.mean(filter(wohnk.df,owner == 1 & belastet == 0 & notrücklagen == 0)[,c], filter(wohnk.df,owner == 1 & belastet == 0 & notrücklagen == 0)$hhrf,na.rm = T))
